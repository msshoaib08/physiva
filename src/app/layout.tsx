...
export const metadata: Metadata = {
	...
	description:
		'Physiva is your trusted partner in physiotherapy and rehabilitation, offering expert care starting from just ₹799 to help you heal, restore mobility, and thrive.',
	keywords:
